...
<div class="row longform">
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <img src="/img/downloads/influxdb3-core-show.png" class="downloads--thumb brand-logo" />
      </div>
      <table class="table v-center">
        <thead>
          <tr>
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <img src="/img/downloads/influx-aces-show.png" class="downloads--thumb brand-logo" />
      </div>
      <table class="table v-center">
        <thead>
          <tr>
...
<div class="row longform">
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <img src="/img/downloads/telegraf-show.png" class="downloads--thumb brand-logo" />
      </div>
      <table class="table v-center">
        <thead>
          <tr>
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h2 class="panel-title">Telegraf Enterprise</h2>
      </div>
      <div class="panel-body">
        <img src="/img/downloads/Telegraf Enterprise.svg" class="downloads--thumb brand-logo" />
      </div>
      <table class="table v-center">
        <thead>
          <tr>
        ...
        <tbody>
          <tr>
            <td><span class="downloads--swatch transparent"></span> Transparent</td>
            <td><a href="/img/downloads/Telegraf Enterprise.svg" target="blank">SVG</a></td>
          </tr>
          <tr>
            <td><span class="downloads--swatch transparent"></span> Transparent</td>
            <td><a href="/img/downloads/Telegraf Enterprise@4x.png" target="blank">PNG</a></td>
          </tr>
          <tr>
            <td><span class="downloads--swatch transparent"></span>Transparent / White Logo</td>
            <td><a href="/img/downloads/Telegraf Enterprise_white.svg" target="blank">SVG</a></td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h2 class="panel-title">Telegraf Controller</h2>
      </div>
      <div class="panel-body">
        <img src="/img/downloads/Telegraf Controller.svg" class="downloads--thumb brand-logo" />
      </div>
      <table class="table v-center">
        <thead>
          <tr>
        ...
        <tbody>
          <tr>
            <td><span class="downloads--swatch transparent"></span> Transparent</td>
            <td><a href="/img/downloads/Telegraf Controller.svg" target="blank">SVG</a></td>
          </tr>
          <tr>
            <td><span class="downloads--swatch transparent"></span> Transparent</td>
            <td><a href="/img/downloads/Telegraf Controller@4x.png" target="blank">PNG</a></td>
          </tr>
          <tr>
            <td><span class="downloads--swatch transparent"></span>Transparent / White Logo</td>
            <td><a href="/img/downloads/Telegraf Controller_white.svg" target="blank">SVG</a></td>
          </tr>
        </tbody>
      </table>
    </div>

...
<div class="row">
  <div class="col-xs-12">
    <div class="page-header">
      ...
      <a href="#title">
        <h1>Secondary Typeface:<br/>Roboto Sans</h1>
      </a>
    </div>
  </div>
  <div class="col-xs-12">
    ...
    <h5>Usage Rules</h5>
    <ol>
      <li>The secondary typeface is for use in all contexts outside of the logo and its variations, including web, social media, and print graphics</li>
